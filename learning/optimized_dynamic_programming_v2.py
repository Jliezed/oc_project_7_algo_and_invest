...
# Read the dataset
dataset_path = "./data/dataset1_Python+P7.csv"
original_dataset = pandas.read_csv(dataset_path, delimiter=",")


# -------------------- ADD NEW CALCULATED COLUMN --------------------
original_dataset["PROFIT_FOR_1"] = ((original_dataset["profit"]/100) \
                                      * original_dataset["price"]) / \
                                      original_dataset["price"]


# Sort Dataset
dataset = original_dataset.sort_values(by=["PROFIT_FOR_1"],
                                       ascending=False,
                                       na_position="first")
...
actions_names = dataset.name.to_list()
actions_prices = dataset.price.to_list()
actions_profits = dataset.profit.to_list()
